  ...
  return (
    ...
    >
      {icon && iconPosition === "start" && (
        <img src={icon} className="button__icon--right" alt="button-icon" />
      )}
      {type === "icon" ? (
        <img src={icon} className="button__icon--style" alt="button-icon" />
      ) : (
        <label>{title}</label>
      )}
      {icon && iconPosition === "end" && (
        <img src={icon} className="button__icon--left" alt="button-icon" />
      )}
    </button>
  );
};
